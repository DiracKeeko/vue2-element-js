<template>
  ...
  >
    <div class="rank-list-item__top">
      <div class="item-title text-dark ml-4">{{ basicData.title }}</div>
    </div>
    <div class="rank-list-item__bottom">
      <span class="profit-label text-grey ml-4">近1年</span>
      <span class="profit-value ml-3" :style="{ color: setValueColor(basicData.gain) }">
